...
export class AddProduct extends React.Component {
  ...
  onSubmit(e) {
    ...
    axios.post('/api/v1/product/', bodyFormData, {
      headers: {
  ...
  render() {
    ...
    const thumbs = img.map(file => (<div style={thumb}>
      ...
      <div class="columns">
        <div class="column">
          <form onSubmit={this.onSubmit.bind(this)}>
            ...
            <div class="field">
              <label class="label subtitle">Drop your images here
              </label>
              <div class="control">
                <section>
                  <Dropzone accept="image/*" onDrop={this.onDrop.bind(this)} multiple={true}>Drop your images here
                  </Dropzone>
